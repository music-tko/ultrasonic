...
?>
  <div class="CTA_container py-2 px-11 max-w-full lg:w-10/12 rounded-xl flex justify-between items-center" style="background-color: <?php echo esc_attr($cta_background_color); ?>">
