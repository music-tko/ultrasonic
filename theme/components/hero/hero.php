...
<div class="Hero_container flex flex-col lg:flex-row-reverse lg:items-center lg:justify-items-end gap-5 max-w-full mx-auto">
  <div class="Hero_container__image lg:w-7/12">
    <?php if (!empty($hero_image)) : ?>
      <img src="<?php echo esc_url($hero_image['url']); ?>" alt="<?php echo esc_attr($hero_image['alt']); ?>" class="w-full" />
    <?php endif; ?>
  </div>
  <div class="Hero_container__texts lg:w-4/12	w-2/5 pt-2 px-4 lg:p-4">
